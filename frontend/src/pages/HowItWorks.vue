<template>
    ...
    <section class="container mx-auto">
        <h1 class="ml-5 text-[#364958] font-bold text-3xl mt-5 mb-5">How it Works!</h1>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="md:w-7/12 sm:w-full lg:w-7/12 mr-auto px-4">
                ...
                <p class="leading-relaxed text-slate-500">For individuals who believe in the importance of
                    contributing and
                    desire to be part of the transformation they want to see, Best Deed works with a distinctive
                    approach and helps
                    streamline the crowdfunding environment.</p>

                <p class="leading-relaxed text-slate-500 mt-3">Whether it's your cause or one that you support,
                    we'll
                    assemble communities, pertinent partners, cutting-edge tools, and resources to meet your product
                    needs
                    efficiently.</p>

                <p class="leading-relaxed text-slate-500 mt-3   ">With our one-of-a-kind platform that enables
                    people all
                    around the world to give towards goods required by NGOs, we have revolutionized the crowdfunding
                    sector. We are
                    working hard to change the world by connecting people together to have a lasting influence. We do
                    this with the
...
export default {
    ...
    created() {
        document.title = this.$t("How It Works")
    }
}
</script>