    ...
    <div class=" bg-white">
        ...
        <div class="container bg-white mx-auto px-5 pb-5 sm:mt-1 md:mt-10 lg:mt-10 mb-10">
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 md:gap-6 lg:gap-0 mt-10">
                <div v-for="data in blogs" @click="openblog(data.name)"
                    class="pb-0 md:pb-0 lg:pb-0 pt-0 md:pt-0 lg:pt-0 grid ">
                    <div
                        ...
                        <div class="pt-9 pr-9  md:pr-6 lg:pr-9 pd-7 pl-9 md:pl-6 lg:pl-9 ">
                            ...
                            <!-- <p>{{ data.blogger }}</p>
                            <p>{{ formatDate(data.published_on) }}</p> -->
                            ...
                            <div class="flex pb-4">
                                <div class="">
                                    ...
                                    <Avatar :imageURL="data.blogger" :label="data.blogger" size="lg"
                                        class="w-12 h-12 rounded-full" />
                                </div>
                                <div class="lg:w-9/12 xl:w-9/12">
                                    <p class="text-[16px] text-[#40b751] font-black">{{ data.blogger }}</p>
                                    <p class="text-[#aaa]">{{ formatDate(data.published_on) }}</p>
                                </div>
                            </div>
