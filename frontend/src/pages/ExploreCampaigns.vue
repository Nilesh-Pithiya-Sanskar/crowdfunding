                ...
                <div v-if="index - 1 < campaigns.length" class="pb-0 md:pb-0 lg:pb-0 pt-0 md:pt-0 lg:pt-0 grid ">
                    <div
                        ...
                        <div class="pt-[10px] pr-[20px] pl-[20px] leading-6">
                            ...
                            <div class="w-full bg-gray-200 rounded h-[16px] dark:bg-gray-700 mt-3 mb-3 ">
                            ...
                            <div
                                class="fontcard flex border-b-2 border-b-gray-100  justify-between mt-3 mb-3 pb-3 text-[14px] md:text-[12px] lg:text-[14px]">
...
export default {
    ...
    mounted() {
        document.title = "Explore Campaigns"
        this.get_campaigns()
