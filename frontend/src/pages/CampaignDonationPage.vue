        ...
        <div v-if="campaign_detail" class="px-[14px] md:px-0 lg:px-0">
            ...
            <h2 v-if="lang == 'gu' && campaign_detail.data.campaign_title_gu">
                ...
                <span v-for="benefit in campaign_detail.data.benefits">
                    <button v-if="lang == 'gu' && benefit.benefit_gu"
                        class="bg-[#364958] mr-[2px] capitalize text-[13px] font-normal text-white px-3 rounded-[12px] cursor-text">
                        {{ benefit.benefit_gu }}
                    </button>
            ...
            <h2 v-else-if="lang == 'hi' && campaign_detail.data.campaign_title_hi">
                ...
                <span v-for="benefit in campaign_detail.data.benefits">
                    ...
                    <button v-else
                        class="bg-[#364958] mr-[2px] capitalize text-[13x] font-normal text-white px-3 rounded-[12px] cursor-text">
                        {{ benefit.benefit }}
                    </button>
                </span>
            </h2>
            ...
            <div class="flex flex-wrap mt-6 mb-5">
                <div class="w-full lg:w-8/12 pr-0 md:pr-4 lg:pr-4">
                    <!-- <DonationDetail /> -->
                    <img class="h-96 mb-4 object-cover w-full rounded-[6px]" :src="campaign_detail.data.campain_image">
                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-3 mt-6">
                        <div class="pb-4" v-for="products in campaign_detail.data.add_campaign_items">
                            <!-- {{ products }} -->
                            <div class="block product-shodow border border-green-500 rounded-md bg-white p-3 h-full">
                                <div class="flex items-start !self-start">
                                    <div class="lg:flex lg:w-3/12 xl:w-3/12">
                                        <img :src="products.image" :alt="products.display_as_name" class="w-20 h-20" />
                                    </div>
                                ...
                                <div class="flex justify-between !items-end flex-wrap !self-end">
                                    ...
                                    <div>
                                        ...
                                        <p v-if="lang == 'gu' && products.about_gu" class="text-gray-500 mb-0 text-[12px]">
                                            {{ $t(products.about_gu) }}
                                        </p>
                                        <p v-else-if="lang == 'hi' && products.about_hi"
                                            class="text-gray-500 mb-0 text-[12px]">
                                            {{ $t(products.about_hi) }}
                                        </p>
                                        <p v-else class="text-gray-500 mb-0 text-[12px]" v-if="products.about">
                                            {{ $t(products.about) }}
                                        </p>
                                    </div>
                                    <div class="flex ml-3" v-if="item_b.includes(products.item)">
                                        <div
                                            class="flex justify-end text-xl h-9 mr-1 border bg-transparent border-[#40b751] rounded">
                                            <Button
                                                class="bg-gray-300 !p-2 !border-0 !border-r !bg-transparent border-[#40b751] !rounded-none"
                                                @click="decrement(products.item, products.price, qty = 1)">-</Button>

                                            <div v-for="item in item_cart">
                                                <div class="bg-[#40b751] py-1 px-2 rounded-lg justify-center text-[14px] !border-0 !bg-transparent"
                                            ...
                                            <Button
                                                class="bg-gray-300 !p-2 !border-0 !border-l !bg-transparent border-[#40b751] !rounded-none"
                                                @click="increment(products.item, products.price, qty = 1, products.qty, products.c_qty)">+</Button>
                                        </div>
                                    </div>

                                    <div v-else-if="products.qty != products.c_qty">
                                        <div class="grid justify-items-end w-24 text-xl h-9 mr-0">
                                            <div>
                                                <button
                ...
                <div class=" w-full lg:w-4/12 pr-0 md:pr-4 lg:pr-4">
                    <div class="sticky top-0 card-shodow p-5 rounded-[6px]">
                        <div class="sidebar-progress-meter">
                            <div class="pb-2 mb-[6px] flex text-[#364958]">
                                <p class="font-bold text-[20px] leading-none">₹{{
                                    numberWithCommas(campaign_detail.data.raised_amount) }}</p>
                                <p class="ml-1">{{ $t('raised') }} {{ $t('of') }} ₹{{
                                    numberWithCommas(campaign_detail.data.donation_amount) }}</p>
                            </div>
                            <div class="w-full h-[5px] bg-gray-200 rounded-md dark:bg-gray-700">
                                ...
                                <div v-else
                                    class="bg-[#40b751] h-[5px] text-[11px] font-medium text-black text-center p-0.5 leading-none rounded"
                           ...
                           {{ (campaign_detail.data.raised_amount * 100 / campaign_detail.data.donation_amount).toFixed(2)
                            ...
                            <div class="flex flex-wrap mt-2 justify-between">
                                <div class="flex flex-wrap">
                                    <p class="flex iconword !text-[14px]">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" class="wordicon feather feather-users svg-sm">
                                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                                            <circle cx="9" cy="7" r="4"></circle>
                                            <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
                                            <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                                        </svg>{{ numberWithCommas(total_donors) }} {{ $t('Donors') }}
                                    </p>
                                    <!-- <p class="flex item-center iconword"> <svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="wordicon feather feather-clock">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <polyline points="12 6 12 12 16 14"></polyline>
                                </svg> {{ campaign_days }} {{ $t('Days Left') }}</p> -->

                                </div>
                                <div class="flex flex-wrap mt-0 md:mt-0 lg:mt-0 social-sm">
                                    <div class="bg-blue-700 rounded-full bgicon hover:cursor-pointer">
                                        <ShareNetwork network="facebook" :url="url"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff"
                                                ...
                                                stroke-linejoin="round" class="iconsize feather feather-facebook">
                                                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z">
                                                </path>
                                            </svg>
                                        </ShareNetwork>
                                    </div>
                                    <div class="bg-sky-400 rounded-full bgicon hover:cursor-pointer">
                                        <ShareNetwork network="Twitter" :url="url"
                                            :title="campaign_detail.data.campaign_title">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff"
                                                stroke="currentColor" stroke-width="0" stroke-linecap="round"
                                                stroke-linejoin="round" class="iconsize feather feather-twitter">
                                                <path
                                    ...
                                    <div class="bg-[#40b751] rounded-full bgicon hover:cursor-pointer">
                                        <ShareNetwork network="WhatsApp" :url="url"
                                            :title="campaign_detail.data.campaign_title"
                                            :description="campaign_detail.data.short_description">
                                    ...
                                    <div class="bg-gray-600 rounded-full bgicon hover:cursor-pointer" @click="copyURL()">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round" class="linkiconsize feather feather-link">
                        ...
                        <div class="overflow-hidden hidden lg:block mt-3">
                            <table class="text-[#364958]" v-if="item_cart != ''">
                                <thead class="bg-white border-b">
                                    <tr>
                                        <th scope="col" class="font-bold px-2 py-3 text-left">
                                            {{ $t('Item') }}
                                        </th>
                                        <!-- <th scope="col" class="text-sm font-bold text-gray-900 px-6 py-4 text-left">
                                            Rate
                                        </th> -->
                                        <th scope="col" class="font-bold px-10 py-3 text-center">
                                            {{ $t('Qty') }}
                                        </th>
                                        <th scope="col" class="font-bold px-10 py-3 text-right">
                                            {{ $t('Amount') }}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="item in item_cart"
                                        ...
                                        <td class="text-sm text-gray-900 px-2 py-2">
                                            {{ $t(item.item) }}
                                        </td>
                            ...
                            <div class="text-center mt-5" v-if="item_cart == ''">
                                <button
                                    class="w-full border rounded-lg bg-[#40b751] hover:bg-white text-white hover:border-[#40b751] hover:border hover-border-solid hover:text-[#40b751] active:bg-green-600 uppercase text-sm md:text-sm lg:text-sm px-6 py-3 shadow hover:shadow-lg outline-none focus:outline-none ease-linear transition-all duration-150"
                                    type="button" @click="donate_now()"> {{ $t('Donate Now') }}
                                </button>
                            </div>
                            <div class="text-center mt-5" v-if="item_cart != ''">
                                <button
                                    class="mb-3 w-full border rounded-lg bg-[#40b751] hover:bg-white text-white hover:border-[#40b751] hover:border hover-border-solid hover:text-[#40b751] active:bg-green-600 uppercase text-sm md:text-sm lg:text-sm px-6 py-3 shadow hover:shadow-lg outline-none focus:outline-none ease-linear transition-all duration-150"
            ...
            <section class="bg-white dark:bg-gray-900 flex flex-wrap">
                ...
                <div class="w-full md:w-6/12 lg:w-4/12 mb-10 md:mb-0 lg:mb-0">
                    <div class="text-2xl md:text-[26px] text-[#40b751] font-semibold title-font text-2xl mb-2">{{
                        $t('Donors') }} ({{
        total_donors }})</div>
                            ...
                            <ul class="flex mb-0 list-none flex-wrap flex-row">
                                <li class="-mb-px flex-auto text-center">
                                    <a class="text-sm font-medium  px-5 py-3 shadow-lg rounded block leading-normal cursor-pointer"
                                        ...
                                        v-bind:class="{ 'bg-white text-gray-500 ': openTab !== 1, 'bg-[#ebf8ec]': openTab === 1 }">
                                ...
                                <li class="-mb-px  flex-auto text-center">
                                    <a class="text-sm font-medium  px-5 py-3 shadow-lg rounded block leading-normal cursor-pointer"
                                        ...
                                        v-bind:class="{ 'bg-white text-gray-500 ': openTab !== 2, 'bg-[#ebf8ec]': openTab === 2 }">
                                                    ...
                                                    <div class="flex pr-4">
                                                        <div v-if="donation.anonymous != 1">
                                                            <Avatar :imageURL="donation.donor_image"
                                                                :label="donation.donor_name" size="md"
                                                                class="w-[40px] h-[40px] rounded-full mr-2" />
                                                        </div>
                                                        <div v-else>
                                                            <Avatar imageURL="" label="Anonymous" size="md"
                                                                class="w-[40px] h-[40px] rounded-full mr-2" />
                                                        </div>
                                                        <div>
                                                            <p v-if="donation.anonymous != 1"
                                                                class=" text-gray-900 leading-none text-lg w-full">{{
                                                    ...
                                                    <div class="flex pr-4">
                                                        <div v-if="m_donation.anonymous != 1">
                                                            <Avatar :imageURL="m_donation.donor_image"
                                                                :label="m_donation.donor_name" size="md"
                                                                class="w-[40px] h-[40px] rounded-full mr-2" />
                                                        </div>
                                                        <div v-else>
                                                            <Avatar imageURL="" label="Anonymous" size="md"
                                                        ...
                                                        <div>
                                                            ...
                                                            <p v-else class="text-gray-900 leading-none text-lg w-full">
                                                                {{ $t('Anonymous') }}</p>
                                                            <p class="text-gray-600 text-sm w-full">{{ formatDate(m_donation.date)
                                                            }}
                                                            </p>
                                                        </div>
                                                    </div>
